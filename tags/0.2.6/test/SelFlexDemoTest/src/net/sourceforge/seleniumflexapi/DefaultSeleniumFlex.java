...
public class DefaultSeleniumFlex extends DefaultSelenium {
	...
	protected void handleException(SeleniumException e, String command,
			String target, String args) {
		System.out.println(e.getMessage());
		System.out.println("Failed command : " + command + "(" + target + ", "
				+ args + ")");
	}

	protected String executeCommand(String command, String target, String args)
			throws Exception {
		String retval = "";
		try {
			retval = this.commandProcessor.doCommand(command, new String[] {
					target, args });
	...
	public void flexClickDataGridItem(String target, String args)
			throws Exception {
	...
	public void flexClickDataGridUIComponent(String target, String args)
			throws Exception {
	...
	public void flexClickMenuBarUIComponent(String target, String args)
			throws Exception {
	...
	public void flexWaitForElementVisible(String target, String args)
			throws Exception {
	...
	public void flexRefreshIDToolTips(String target, String args)
			throws Exception {
	...
	public String getFlexDataGridUIComponentLabel(String target, String args)
			throws Exception {
		return executeCommand("getFlexDataGridUIComponentLabel", target, args)
				.replace("OK,", "");
	}
	...
	public String getFlexASProperty(String target, String args)
			throws Exception {
		return executeCommand("getFlexASProperty", target, args).replace("OK,",
				"");
	}

	public String getFlexASProperty(String target) throws Exception { 
		return executeCommand("getFlexASProperty", target, "").replace("OK,", ""); }

	public String getFlexAlertPresent(String target, String args)
			throws Exception {
		return executeCommand("getFlexAlertPresent", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexAlertTextPresent(String target, String args)
			throws Exception {
		return executeCommand("getFlexAlertTextPresent", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexCheckBoxChecked(String target, String args)
			throws Exception {
		return executeCommand("getFlexCheckBoxChecked", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexComponentInfo(String target, String args)
			throws Exception {
		return executeCommand("getFlexComponentInfo", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexDataGridCellText(String target, String args)
			throws Exception {
		return executeCommand("getFlexDataGridCellText", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexEnabled(String target, String args) throws Exception {
		return executeCommand("getFlexEnabled", target, args)
				.replace("OK,", "");
	}

	public String getFlexEnabled(String target) throws Exception { return executeCommand("getFlexEnabled", target, "").replace("OK,", ""); }

	public String getFlexErrorString(String target, String args)
			throws Exception {
		return executeCommand("getFlexErrorString", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexExists(String target) throws Exception { return executeCommand("getFlexExists", target, "").replace("OK,", ""); }

	public String getFlexGlobalPosition(String target, String args)
			throws Exception {
		return executeCommand("getFlexGlobalPosition", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexNumeric(String target, String args) throws Exception {
		return executeCommand("getFlexNumeric", target, args)
				.replace("OK,", "");
	}
	...
	public String getFlexRadioButton(String target, String args)
			throws Exception {
		return executeCommand("getFlexRadioButton", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexSelectionIndex(String target, String args)
			throws Exception {
		return executeCommand("getFlexSelectionIndex", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexStepper(String target, String args) throws Exception {
		return executeCommand("getFlexStepper", target, args)
				.replace("OK,", "");
	}
	...
	public String getFlexTextPresent(String target, String args)
			throws Exception {
		return executeCommand("getFlexTextPresent", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexVisible(String target, String args) throws Exception {
		return executeCommand("getFlexVisible", target, args)
				.replace("OK,", "");
	}
